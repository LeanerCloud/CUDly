...
describe('History Module', () => {
  ...
  describe('loadHistory', () => {
    ...
    // Migration 000078 (expand-contract rename cancelled -> canceled): during
    ...
    test('Cancelled badge + chip surface BOTH spellings during deploy window (migration 000078)', async () => {
      (api.getHistory as jest.Mock).mockResolvedValue({
        summary: {},
        purchases: [
