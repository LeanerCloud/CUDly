...
// unattributed plans.
func (h *Handler) planIntersectsAllowed(ctx context.Context, planID string, allowed []string) (bool, error) { //nolint:unused // retained for scoped-user plan-visibility path
