...
func (s *PostgresStore) ListStoredRecommendations(ctx context.Context, filter RecommendationFilter) ([]RecommendationRecord, error) { //nolint:gocritic // hugeParam: filter is value-typed to satisfy the config.StoreInterface contract; pointer cascade deferred
