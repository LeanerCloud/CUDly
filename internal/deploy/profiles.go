...
func (c *DeploymentConfig) AddProfile(name string, profile ProfileConfig) error { //nolint:gocritic
	if name == "" {
...
func (c *DeploymentConfig) UpdateProfile(name string, profile ProfileConfig) error { //nolint:gocritic
	if _, exists := c.Profiles[name]; !exists {
