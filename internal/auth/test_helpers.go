...
func (m *MockStore) GetUserByID(ctx context.Context, userID string) (*User, error) {
	...
	return args.Get(0).(*User), args.Error(1) //nolint:errcheck // testify mock type assertion
}
...
func (m *MockStore) GetGroup(ctx context.Context, groupID string) (*Group, error) {
	...
	return args.Get(0).(*Group), args.Error(1) //nolint:errcheck // testify mock type assertion
}
...
func (m *MockStore) GetSession(ctx context.Context, token string) (*Session, error) {
	...
	return args.Get(0).(*Session), args.Error(1) //nolint:errcheck // testify mock type assertion
}
...
func (m *MockStore) GetAPIKeyByID(ctx context.Context, keyID string) (*UserAPIKey, error) {
	...
	return args.Get(0).(*UserAPIKey), args.Error(1) //nolint:errcheck // testify mock type assertion
}
