...
func NewSMTPSender(cfg SMTPConfig) (*SMTPSender, error) { //nolint:gocritic // hugeParam: by-value per calling convention
	if cfg.Host == "" {
...
func (s *SMTPSender) SendNewRecommendationsNotification(ctx context.Context, data NotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendScheduledPurchaseNotification(ctx context.Context, data NotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendPurchaseConfirmation(ctx context.Context, data NotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendPurchaseFailedNotification(ctx context.Context, data NotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendRIExchangePendingApproval(ctx context.Context, data RIExchangeNotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendRIExchangeCompleted(ctx context.Context, data RIExchangeNotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendPurchaseApprovalRequest(ctx context.Context, data NotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendPurchaseScheduledNotification(ctx context.Context, data NotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendRegistrationReceivedNotification(ctx context.Context, data RegistrationNotificationData) error { //nolint:gocritic // hugeParam: by-value per calling convention
...
func (s *SMTPSender) SendRegistrationDecisionNotification(ctx context.Context, toEmail string, data RegistrationDecisionData) error { //nolint:gocritic // hugeParam: by-value per calling convention
